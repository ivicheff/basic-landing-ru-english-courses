...
export default function CareerCard({ job, className }: CareerCardProps) {
  ...
  const labels = (content.careers as { labels: CareersLabels }).labels;

  return (
    <div
      className={`flex flex-col gap-4 rounded-lg border-none p-6 shadow-sm transition-all hover:shadow-md ${
